<!DOCTYPE html>
<%@page import="com.dao.student.StudentDao"%>
...
<title>ROYAL TECHNOSOFT DASHBOARD</title>
    ...
    -->
			<div class="logo">
				<a href="http://www.creative-tim.com"
					class="simple-text logo-normal"> Cre </a>
			</div>
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					<li class="nav-item active  "><a class="nav-link"
						href="../addstudent"> <i class="material-icons"></i>
							<p>add student</p>
					</a></li>
					<li class="nav-item active  "><a class="nav-link"
						href="../studentlist"> <i class="material-icons">studentList</i>
							<p>student list</p>
					</a></li>
					<li class="nav-item active  "><a class="nav-link"
						href="../addremarks"> <i class="material-icons">add
								remarks</i>
							<p>add remark</p>
					</a></li>
					</li>
					<li class="nav-item active  "><a class="nav-link"
						href="../remarkslist"> <i class="material-icons">view
								remarks</i>
							<p>view all remark</p>
					</a></li>
					<!-- <li class="nav-item ">
						...
						<ul class="navbar-nav">
							...
							<li class="nav-item dropdown"><a class="nav-link"
								...
								<div class="dropdown-menu dropdown-menu-right"
									...
									<a class="dropdown-item" href="loginpage">LOGIN</a> <a
                    ...
                    <i class="material-icons">update</i> Just Updated
						...
						<div class="row">
												...
												<ul class="nav nav-tabs" data-tabs="tabs">
													<li class="nav-item"><a class="nav-link active"
														href="#profile" data-toggle="tab"> <i
															class="material-icons">BOOT CAMPS</i>
															<div class="ripple-container"></div>
													</a></li>
												...
												<table class="table">
													<tbody>
														<tr>
															...
															<td>Sign contract for "What are conference
							...
							<div class="col-lg-6 col-md-12">
								<div class="card">
									<div class="card-header card-header-warning">
										<h4 class="card-title">Faculty Stats</h4>
										<p class="card-category">employees on 15th September, 2020</p>
									</div>
