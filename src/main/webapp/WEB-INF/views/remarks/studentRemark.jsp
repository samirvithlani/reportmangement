...
<title>add student remark</title>
			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand" href="javascript:;">VIEW REMARKS </a>
					</div>
						...
						<div class="col-md-8 ml-auto mr-auto">
							<div class="card">
								<div class="card-header card-header-primary">
									...
									<p class="card-category">Are you looking for more
										components</p>
								</div>
								<div class="card-body">
									<div class="table-responsive table-upgrade">
										...
										<!-- ************************************************ -->
										<table class="table">
											<c:forEach var="sremark" items="${studentRemark }">
												<thead>
													<tr>
														<th></th>
														<th class="text-center">STUDNT NAME</th>
														<th class="text-center">${sremark.sName }</th>
													</tr>
												</thead>
												...
												<tbody>
													<tr>
														<td>DESCIPLINE</td>
														<td class="text-center">${sremark.discipline }</td>

													</tr>
													<tr>
														<td>REGULARITY</td>

														<td class="text-center">${sremark.regularity }</td>
													</tr>
													<tr>
														<td>GRASPING</td>

														<td class="text-center">${sremark.grasping}</td>
													</tr>
													<tr>
														<td>DOUBT SOLVING</td>
														<td class="text-center">${sremark.doubtsolving}</td>
													</tr>
													<tr>
														<td>UPGRADATION</td>

														<td class="text-center">${sremark.upgradation}</td>
													</tr>
													<tr>
														<td>RESERCH</td>

														<td class="text-center">${sremark.reserch }</td>
													</tr>
													<tr>
														<td>TASK</td>

														<td class="text-center">${sremark.task}</td>
													</tr>
													<tr>
														<td>EXAMS</td>

														<td class="text-center">${sremark.exams}</td>
													</tr>

													<tr>
														<td>DATE</td>
														<td class="text-center">${sremark.rDate }</td>

													</tr>

													<tr>
														<td class="text-center">
														<td><a href="../generatestudentremarkreport/${sremark.sId }" class="btn btn-round btn-fill btn-info">GENERATE REPORT</a></td>	
													</tr>
												</tbody>
											</c:forEach>
										</table>
