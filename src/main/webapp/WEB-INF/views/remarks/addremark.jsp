			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand" href="javascript:;">ADD REMARKS</a>
					</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="table-responsive table-upgrade">
										...
										<form:form action="../insertremark"
										
											modelAttribute="remarkBean" method="post">
											...
											<table class="table">
												...
												<tbody>
													<tr>
														<td>DESCIPLINE</td>
														<td><form:input type="text" path="discipline" /></td>
														<td class="text-center">60</td>

													</tr>
													<tr>
														<td>REGULARITY</td>
														<td><form:input type="text" name="" path="regularity" /></td>
														<td class="text-center">15</td>
													</tr>
													<tr>
														<td>GRASPING</td>
														<td><form:input type="text" path="grasping" /></td>
														<td class="text-center">27</td>
													</tr>
													<tr>
														<td>DOUBT SOLVING</td>
														<td><form:input type="text" name=""
																path="doubtsolving" /></td>
													...
													<tr>
														<td>RESERCH</td>
														<td><form:input type="text" name="" path="reserch" /></td>
														<td><input type="text" name=""></td>
													</tr>
													<tr>
														<td>TASK</td>
														<td><form:input type="text" name="" path="task" /></td>
														<td><input type="text" name=""></td>
													</tr>
													<tr>
														<td>EXAMS</td>
														<td><form:input type="text" name="" path="exams" /></td>
														<td><input type="text" name=""></td>
													</tr>
													...
													<tr>
														...
														<td><form:input type ="date" path="rDate" /></td>
													</tr>

													<tr>
														<td class="text-center"></td>
														<td class="text-center"><td><input type="reset" value="reset"
															class="btn btn-round btn-fill btn-info"></td>
