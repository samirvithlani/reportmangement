						...
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
									...
									<form:form action="insertstudent" method="post"
										...
										<div class="row">
											...
											<div class="col-md-3">
												<div class="form-group">
													<label class="bmd-label-floating">studentName</label>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<form:input type="email" class="form-control" path="sEmail" />
												</div>
											</div>
										</div>
										<div class="row">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<form:input type="text" class="form-control" path="sMobile" />
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">JOINIG YEAR</label>
													<form:input type="text" class="form-control" path="sYear" />
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">BATCH</label>
													<form:input type="text" class="form-control" path="sBatch" />
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group"></div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">FacultyName</label>
													<form:select class="form-control" path="fId">
													<c:forEach var="faculty" items="${faculty }">
													<form:option value="0" label="SELECT FACULTY"></form:option>
													<form:option value="${faculty.fId }" label="${faculty.fName }"></form:option>
													</c:forEach>
													</form:select>
